    ...
    <div className="space-y-2">
      ...
      {hasWarnings && (
        <div className="bg-amber-50 border border-amber-300 rounded-xl px-4 py-3 space-y-1">
          ...
          <p className="text-[10px] text-amber-600 mt-1">ניתן להמשיך — זוהי אזהרה בלבד</p>
        </div>
      )}
      ...
      {/* All good */}
      {!hasWarnings && unconfigured.length === 0 && Object.keys(capacityInfo).length > 0 && (
