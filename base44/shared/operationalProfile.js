export async function ensureExactlyOneOperationalProfile(base44, group, duplicateCode = 'DUPLICATE_OPERATIONAL_PROFILE', initialFields = {}) {
  ...
  const data = { ...initialFields, group_id: group.id, status: 'ACCEPTED' };
