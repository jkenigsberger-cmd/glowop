...
export const formRules = {
  group_details: {
    ...
    rules: "תאריכי ההגעה והעזיבה נקבעו מראש ואינם ניתנים לשינוי בטופס. בקבוצה רציפה ממלאים שעת הגעה ושעת עזיבה יחידות בשלב 'פרטי קבוצה'. בקבוצת MULTI_PERIOD לכל תקופת שהייה יש שדות שעת הגעה ושעת עזיבה משלה, ויש למלא אותם בכל בלוק תקופה. שינוי תאריכים מחייב תיאום דרך ההערות והצוות יחזור אליכם.",
  },
  participants: {
